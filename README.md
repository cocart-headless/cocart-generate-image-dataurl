<h1 align="center">CoCart Generate Image DataUrl</h1>

<p align="center"><img src="https://cocart.xyz/wp-content/uploads/2021/11/cocart-home-default.png.webp" alt="CoCart Logo" /></p>

<br>

This CoCart extension generates image DataUrl for all images so you can use it as a placeholder until the image fully loads.

It is designed as a standalone WordPress plugin or to be pulled in via Composer to be packaged with CoCart should you choose to do a custom build.
...
CoCart Generate Image Data Url is developed and maintained by [Sébastien Dumont](https://github.com/seb86).
